...
const ROLE_LABEL: Record<string, string> = { retailer: 'Retailer', supplier: 'Supplier' }
...
const STAGE_LABEL: Record<string, string> = {
  message: 'Retailer reporting',
  production: 'Supplier producing',
}
  ...
  */
  ...
  return (
    ...
    {/*
      ...
      them itself — and they were RIGHT, which is why "restyle infoshare" was the wrong
    ...
    */}
    ...
    >
      {/* ⚠ ONLINE HAS NO "Match Now" — it pre-groups the roster instead. These are the
          ...
          both, which is where infoshare's extra height came from.
